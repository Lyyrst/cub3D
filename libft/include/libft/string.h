...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/31 08:58:32 by mrouault          #+#    #+#             */
/*   Updated: 2024/05/01 14:57:54 by kbutor-b         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_string						string_trim(t_string *str, const char *cutset,
									bool destroy);
bool							string_equal(t_string *str1, t_string *str2);
...
int								string_find_char(t_string *str,
									const char to_find);
void							string_replace_char(t_string *str,
									char to_find, char to_replace);
